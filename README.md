...
* If Nans are greater than 10% of the data, we can utalize $spline interprolation$ (overlapping polynomial function curves to interpret missing data). This is logical as splines are capable of adjsuting the the often non-linear patterns in financial data 
